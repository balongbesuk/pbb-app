...
export default async function CetakLaporanPage({
  ...
  const css = `
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .summary-box .lbl { font-size: 9pt; color: #444; margin-bottom: 2px; }
    ...
    @media print {
      ...
      .page { margin: 0; padding: 15mm 15mm 20mm 20mm; box-shadow: none; }
  ...
  return (
    <>
      ...
      {/* Tombol Cetak — Client Component, tidak ikut tercetak */}
      <PrintButtons />
      ...
      <div className="page">
        ...
        <div className="summary-grid">
          <div className="summary-box">
            <div className="lbl">Total Wajib Pajak</div>
            <div className="val">{totalWp.toLocaleString("id-ID")} WP</div>
            <div className="sub">Lunas: {totalLunas} | Belum: {totalBelum}</div>
          </div>
          <div className="summary-box">
            <div className="lbl">Target Penerimaan</div>
            <div className="val">{fmt(totalTarget)}</div>
          </div>
          <div className="summary-box">
            <div className="lbl">Total Realisasi</div>
            <div className="val">{fmt(totalRealisasi)}</div>
            <div className="sub">Progress: {totalProgress}%</div>
          </div>
          <div className="summary-box">
            <div className="lbl">Sisa Piutang</div>
            <div className="val">{fmt(totalSisa)}</div>
          </div>
        </div>
        ...
        <div className="signatures">
          <div className="signature-block">
            ...
            <p className="sig-name">( __________________ )</p>
